$(function ()
{
    var data = [
        ...
        },
        {
            id: 2,
            title: 'Pain',
            body: 'If you are pained by any external thing, it is not this thing that disturbs you, but your own judgement about it. And it isin your power to wipe out this judgement now.',
    ...
    function initPosts()
    {
        for (let i = 0; i < data.length; i++)
        {
            ...
            //wire up nav item click even handler
